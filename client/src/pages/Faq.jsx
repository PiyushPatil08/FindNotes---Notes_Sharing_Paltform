...
const Faq = () => {
  const faqs = [
    ...
    {
      question: "Can I collaborate with other students on projects using FindMyNotes?",
      answer:
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-5 bg-gray-900 text-white">
      <div className="max-w-6xl w-full px-5 py-10">
        <h1 className="text-3xl font-black text-center mb-8 text-blue-400">
          Frequently Asked Questions
        </h1>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {faqs.map((item, i) => (
            <div key={i} className="bg-gray-800 p-5 rounded-xl shadow-lg">
              <h1 className="mb-2 text-lg font-medium text-blue-300">
                {item.question}
              </h1>
